        ...
        match expr {
            ...
            Expression::Typed { expr, ty } => {
                ...
                let expected_type = match ty {
                    crate::frontend::ast::Type::Int => Type::Integer,
                    crate::frontend::ast::Type::Float => Type::Float,
                    crate::frontend::ast::Type::String => Type::String,
                    crate::frontend::ast::Type::Bool => Type::Bool,
                    crate::frontend::ast::Type::List(_) => Type::List(Box::new(Type::Unknown)), // TODO: Handle nested types
                    crate::frontend::ast::Type::Dict(_, _) => {
                        Type::Dict(Box::new(Type::Unknown), Box::new(Type::Unknown))
                    }
                    crate::frontend::ast::Type::Any => Type::Any,
                    crate::frontend::ast::Type::Unit(name) => Type::Unit(name.clone()),
                    crate::frontend::ast::Type::Function(_, _) => {
