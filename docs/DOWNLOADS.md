...
```bash
wget https://github.com/calamity10110/gul/releases/download/v0.13.0/gul-v0.13.0-linux-x86_64.tar.gz
tar xzf gul-v0.13.0-linux-x86_64.tar.gz
...
1. Download: [gul-v0.13.0-windows-x86_64.zip](https://github.com/calamity10110/gul/releases/download/v0.13.0/gul-v0.13.0-windows-x86_64.zip)
...
```bash
wget https://github.com/calamity10110/gul/releases/download/v0.13.0/gul-v0.13.0-macos-universal.tar.gz
tar xzf gul-v0.13.0-macos-universal.tar.gz
sudo mv gul /usr/local/bin/
sudo mv gul-mcp /usr/local/bin/
```
...
```bash
wget https://github.com/calamity10110/gul/releases/download/v0.13.0/gul-v0.13.0-rpi-armv7.tar.gz
tar xzf gul-v0.13.0-rpi-armv7.tar.gz
sudo mv gul /usr/local/bin/
sudo mv gul-mcp /usr/local/bin/
```
...
```bash
wget https://github.com/calamity10110/gul/releases/download/v0.13.0/gul-v0.13.0-rpi-arm64.tar.gz
tar xzf gul-v0.13.0-rpi-arm64.tar.gz
sudo mv gul /usr/local/bin/
sudo mv gul-mcp /usr/local/bin/
```
...
```bash
wget https://github.com/calamity10110/gul/releases/download/v0.13.0/gul-v0.13.0-esp32s3.zip
unzip gul-v0.13.0-esp32s3.zip
```
...
SHA256 checksums for v0.13.0:

```
# Linux
<checksum> gul-v0.13.0-linux-x86_64.tar.gz

# Windows  
<checksum> gul-v0.13.0-windows-x86_64.zip

# macOS
<checksum> gul-v0.13.0-macos-universal.tar.gz

# Raspberry Pi
<checksum> gul-v0.13.0-rpi-armv7.tar.gz
<checksum> gul-v0.13.0-rpi-arm64.tar.gz

# ESP32-S3
<checksum> gul-v0.13.0-esp32s3.zip
```
...
- **v0.13.0** (Latest) - Multi-platform release, MCP integration, v3.2 syntax
